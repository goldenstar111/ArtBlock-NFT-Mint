...
contract DescentCollection is ERC721Enumerable, ERC721Burnable, ReentrancyGuard, Ownable {
    ...
    uint256 private _numOfAvailableTokens = 400;
    uint256[111] private _availableTokens;
    uint256 public constant MAX_MINTABLE_IN_TXN = 3;
    string public baseURI = "https://ipfs.io/ipfs/QmebchXmQUPAZFJjS6NpVGdVoaqUGbGiYe8KM2TnwS8496/";
    ...
    function contractURI() public pure returns (string memory) {
        return "https://ipfs.io/ipfs/QmRouz3XZD4JbPJpkwVEj6oum8JuecbQ2ywCNysSCGZqZ5";
    }
